...
namespace Vendor.Application.Requests.Vendor
{
    ...
    //</Summary>
    public class CreateVendorHandler : IRequestHandler<AddVendorCommand, CreateOrEditDto>
    {
        ...
        public async Task<CreateOrEditDto> Handle(AddVendorCommand request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<CreateOrEditDto>(vendor);
        }
    }
